...
<section class="section section-contact">
    <div class="container">
        <h2 class="contact-title section-title title">Contact Us</h2>
        <div class="row">
            <div class="col-xl-6 col-lg-6 col-md-6 order-xl-1 order-lg-1 order-md-1 order-sm-2 order-2">
                <div class="contact-form">
                    <h4 class="contact-form-title title">Contact Form</h4>
                ...
                <div class="contact-content">
                    <div class="contact-info contact-info-top">
                        ...
                        <div class="contact-details">
                            <h4 class="contact-details-title">E-mail</h4>
                            <ul class="contact-details-list">
                                <li>
                                    <span>Support: </span>support@startfx.com
                                </li>
                                <li>
                                    <span>Advertising: </span>adv@startfx.com
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="contact-info contact-info-bottom">
                        ...
                        <div class="contact-details">
                            <h4 class="contact-details-title">Phone</h4>
                            <ul class="contact-details-list">
                                <li>
                                    <span>Russia </span>+74992210375
                                </li>
                                <li>
                                    <span>UK </span>+442039360928
                                </li>
                                <li>
                                    <span>Germany </span>+4930255579970
                                </li>
                                <li>
                                    <span>Switzerland </span>+41315087461
                                </li>
                            </ul>
                            <ul class="contact-details-list">
                                <li>
                                    <span>Georgia </span>+995706777049
                                </li>
                                <li>
                                    <span>South Africa </span>+27104426053
                                </li>
                                <li>
                                    <span>Austria </span>+43720775635
                                </li>
                            </ul>
                        </div>
                    </div>
...
<section class="section section-location js-scroll-block">
   <div class="container">
       <div class="location-details text-center">
           ...
           <h4 class="location-details-title">Address</h4>
           <h5 class="location-details-place">Georgia, Tbilisi, Sandro Euli №3</h5>
       </div>
       <div class="row">
           <div class="col-lg-12">
