...
<div class="wrapper container js-scroll-block">
  <div class="row">
    <div class="col-md-12 col-xs-12 col-sm-12 text-center">
      ...
      <div class="title">Мгновенное пополнение счета</div>
    </div>
    <div class="col-lg-4 col-md-12 col-xs-12 col-sm-12 form">
      <form id="form" method="get" action="#" onsubmit="return false;">
        ...
        <a href="#" class="cover-btn" id="genbtn" type="image" alt="Process Payment" onclick="submitForm(); return false;">Оплатить</a>
  ...
  <div class="row add_footer">
    <div class="col-md-4 col-xs-12 col-sm-12 text-center">
      ...
      <div>
        <span class="one">Безопасность</span>
        <span>Сертификация PCI DSS 3.2</span>
        <span>3D Secure, оставляем</span>
      </div>
    </div>
    <div class="col-md-4 col-xs-12 col-sm-12 text-center">
      <img src="../common/images/uniteller/reliability_icon_51x34.png" width="50px" height="50px">
      <div>
        <span class="one">Надежность</span>
        <span>Работа с крупнейшими Банками-эквайерами в России и за рубежом</span>
        <span>Высокая конверсия платежей</span>
      </div>
    </div>
    <div class="col-md-4 col-xs-12 col-sm-12 text-center">
      <img src="../common/images/uniteller/functionality_icon_48x44.png" width="50px" height="50px">
      <div>
        <span class="one">Высокая конверсия платежей</span>
        <span>Простая интеграция</span>
        <span>10+ платёжных инструментов</span>
      </div>
    </div>
  </div>
</div>
