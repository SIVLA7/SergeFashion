<?php
  ...
  $blogArr = $blog->getAllBlog('ru', $offset, $records_per_page);
?>
<link rel="stylesheet" href="../common/css/blog.css">
<section class="section section-blog">
    <div class="container">
        <h1 class="section-blog-title section-title title">Блог</h1>
          ...
          <?php
            foreach($blogArr as $item) { ?>
              <div class="post-col col-lg-4 col-md-4 col-sm-12 col-12">
                ...
                <a href="blog-post.php?id=<?php echo $item['id']; ?>" class="text-btn btn-move text-uppercase">Узнать больше</a>
              </div>
          <?php } ?>
        </div>
