...
<div class="wrapper container js-scroll-block">
  <div class="row">
    <div class="col-md-12 col-xs-12 col-sm-12 text-center">
      ...
      <div class="title">მყისიერად ანგარიშის შევსება</div>
    </div>
    <div class="col-lg-4 col-md-12 col-xs-12 col-sm-12 form">
      <form id="form" method="get" action="#" onsubmit="return false;">
        ...
        <a href="#" class="cover-btn" id="genbtn" type="image" alt="Process Payment" onclick="submitForm(); return false;">პროცენტის გადახდა</a>
  ...
  <div class="row add_footer">
    <div class="col-md-4 col-xs-12 col-sm-12 text-center">
      ...
      <div>
        <span class="one">უსაფრთხოება</span>
        <span>სერტიფიკაციის PCI DSS 3.1</span>
        <span>3D უსაფრთხო</span>
      </div>
    </div>
    <div class="col-md-4 col-xs-12 col-sm-12 text-center">
      <img src="../common/images/uniteller/reliability_icon_51x34.png" width="50px" height="50px">
      <div>
        <span class="one">საიმედოობა</span>
        <span>თანამშრომლობა უმსხვილესი ბანკებთან-მეწარმეებთან რუსეთში და საზღვარგარეთ</span>
        <span>გადახდების მაღალი კონვერტაცია</span>
      </div>
    </div>
    <div class="col-md-4 col-xs-12 col-sm-12 text-center">
      <img src="../common/images/uniteller/functionality_icon_48x44.png" width="50px" height="50px">
      <div>
        <span class="one">ფუნქციონალობა</span>
        <span>მარტივი ინტეგრაცია</span>
        <span>10 + გადახდის ინსტრუმენტები</span>
      </div>
    </div>
  </div>
</div>
