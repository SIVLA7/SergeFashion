...
<section class="section section-contact">
    <div class="container">
        <h2 class="contact-title section-title title">დაგვიკავშირდით</h2>
        <div class="row">
            <div class="col-xl-6 col-lg-6 col-md-6 order-xl-1 order-lg-1 order-md-1 order-sm-2 order-2">
                <div class="contact-form">
                    <h4 class="contact-form-title title">საკონტაქტო ფორმა</h4>
                    <form id="contact-form" class="contact-form" action="#" method="post" role="form" data-toggle="validator">
                        <div class="row">
                            <div class="col-lg-6 col-md-6">
                                <div class="form-group">
                                    <input class="form-input form-group form-control" id="name" type="text" name="name" placeholder="Name" pattern="[A-Za-zА-Яа-яЁё]{3,}" required>
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="form-group">
                                    <input class="form-input form-group form-control" id="email" type="email" name="email" placeholder="E-mail"  pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" required>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <textarea class="form-input form-group form-control" id="message" name="message" cols="10" rows="4" placeholder="Your message" style="height: 200px; " data-minlength="6" required></textarea>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <button class="btn form-btn form-btn-sm cover-btn" type="submit">
                                        <span>გააგზავნეთ</span>
                                        <b></b>
                                    </button>
                                </div>
                            </div>
                ...
                <div class="contact-content">
                    <div class="contact-info contact-info-top">
                        ...
                        <div class="contact-details">
                            <h4 class="contact-details-title">ელ.ფოსტა</h4>
                            <ul class="contact-details-list">
                                <li>
                                    <span>მხარდაჭერა: </span>support@startfx.com
                                </li>
                                <li>
                                    <span>სარეკლამო: </span>adv@startfx.com
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="contact-info contact-info-bottom">
                        ...
                        <div class="contact-details">
                            <h4 class="contact-details-title">ტელეფონი</h4>
                            <ul class="contact-details-list">
                                <li>
                                    <span>დიდი ბრიტანეთი </span>+442039360928
                                </li>
                                <li>
                                    <span>გერმანია </span>+4930255579970
                                </li>
                                <li>
                                    <span>შვეიცარია </span>+41315087461
                                </li>
                            </ul>
                            <ul class="contact-details-list">
                                <li>
                                    <span>საქართველო </span>+995706777049
                                </li>
                                <li>
                                    <span>სამხრეთ აფრიკა </span>+27104426053
                                </li>
                                <li>
                                    <span>ავსტრია </span>+43720775635
                                </li>
                            </ul>
                        </div>
                    </div>
...
<section class="section section-location js-scroll-block">
   <div class="container">
       <div class="location-details text-center">
           ...
           <h4 class="location-details-title">მისამართი</h4>
           <h5 class="location-details-place">საქართველო, თბილისი, სანდრო ეული №3</h5>
       </div>
       <div class="row">
           <div class="col-lg-12">
