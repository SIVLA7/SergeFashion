                ...
                <div class="callto-action-inner text-uppercase align-items-center">
                    ...
                    <div class="col-lg-6 col-md-5 col-sm-7">
                        <div class="btn-wrapper btn-callto-wrapper">
                            <a href="https://my.startfx.com/ka-ge/signup.aspx" class="btn market-btn btn-lg cover-btn text-uppercase">
                                <span>დაიწყეთ ვაჭრობა</span>
                            </a>
                            <span class="txt-demo txt-demo-md callto-txt-demo">მოყვება უფასო დემო ანგარიში</span>
                        </div>
                    </div>
                </div>
            </div>
